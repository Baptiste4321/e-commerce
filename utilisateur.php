    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            <ul class="standard-ul ma-liste">
                <li class="deroulant nav-li marge-li"><a href="#">Catégories</i></a>
...
<main>
    <div class="container">
        ...
        <div class="button-group">
            ...
            <a href="favoris.html"><i class="fas fa-heart"></i> Mes Favoris</a>
            <a href="commandes.html"><i class="fas fa-box"></i> Mes Commandes</a>
            <a href="infos.html"><i class="fas fa-info"></i> Mes infos</a>
            <a href="ajouter.html"><i class="fas fa-add"></i> Ajouter des articles</a>
            <a href="contact.html"><i class="fas fa-envelope"></i> Nous Contacter</a>
        </div>
...
<footer>
    <div class="footer-container">
        ...
        <div class="category">
            ...
            <table class="flooter">
                <tr>
                    <td class="aled tdpournavbarre"><p style="font-size: 1rem;     font-weight: bold;" >Externe</p></td>
                    <td class="aled tdpournavbarre"><p style="font-size: 1rem;     font-weight: bold; ">Aide</p></td>
                    <td class="aled tdpournavbarre"><p style="font-size: 1rem;     font-weight: bold; ">Catégorie</p></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="aled tdpournavbarre"><a class="liensfooter" href=" ">Mode payement</a></td>
                    <td>
                        <div class="crédit">
                            <table>
                                <tr>
                                    <td class="tdpournavbarre"><a class="crédit_texte ">© 2024 Storehack,  Tous droits réservés</a></td>
